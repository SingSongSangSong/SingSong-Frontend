...
import {KeepAdditionSongsList, OutlineButton} from '../..';
...
const SearchResultForKeepSong = ({
  inputText,
  searchData,
  navigation,
}: SearchResultForKeepSongProps) => {
  ...
  const renderItem = ({item}: {item: [string, Song[]]}) => {
    ...
    return (
      <View key={key} style={tw`my-4`}>
        ...
        <KeepAdditionSongsList songData={songs} />
      </View>
    );
  };
...
export {SearchResultForKeepSong};
