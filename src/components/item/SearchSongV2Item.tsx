...
interface SearchSongV2ItemProps {
  songId: number;
  songNumber: number;
  songName: string;
  singerName: string;
  ...
  return (
    <>
      <TouchableOpacity onPress={handleOnPress} activeOpacity={0.9}>
        <View
          style={tw`flex-row items-center justify-between border-b-[0.5px] border-[${designatedColor.GRAY5}] py-1 px-2 mx-2`}>
